...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://nikolamla.github.io/react_todo-app-add-and-delete/) and add it to the PR description.
  ...
  <TransitionGroup>
    ...
    {creating && (
      <CSSTransition key={0} timeout={300} classNames="temp-item">
        <TodoItem
          todo={{ id: Math.random(), title, completed: false, userId: user.id }}
          isProcessed
        />
      </CSSTransition>
    )}
