...
- send a POST request to the API (check the [API Documentation](https://mat e-academy.github.io/fe-students-api/))
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://jackelashkar.github.io/react_todo-app-add-and-delete/) and add it to the PR description.
