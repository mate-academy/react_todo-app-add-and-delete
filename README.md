...
- Replace `KuzmenkoGit` with your Github username in the [DEMO LINK](https://KuzmenkoGit.github.io/react_todo-app-add-and-delete/) and add it to the PR description.
