...
# â—ï¸â—ï¸â—ï¸</br>Please implement only adding and deleting todos in addition to what was already implemented.<br><br>All the other features from the working version will be implemented in the next task.</br>â—ï¸â—ï¸â—ï¸
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://pabezerra.github.io/react_todo-app-add-and-delete/) and add it to the PR description.
