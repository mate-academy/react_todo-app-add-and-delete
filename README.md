...
> Here is [the working example](https://mate-academy.githusdfadfb.io/react_todo-app-with-api/)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://mrsvolodya.github.io/react_todo-app-add-and-delete/) and add it to the PR description.
