...
- Replace `DenNice-cloud` with your Github username in the [DEMO LINK](https://DenNice-cloud.github.io/react_todo-app-add-and-delete/) and add it to the PR description.
