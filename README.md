...
- Replace `<your_account>` with your GitHub username in the [DEMO LINK](https://artemstadnik.github.io/react_todo-app-add-and-delete/) and add it to the PR description.
