...
- cover the todo with the loader while waiting for the API response;
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://olafchuszno.github.io/react_todo-app-add-and-delete/) and add it to the PR description.
