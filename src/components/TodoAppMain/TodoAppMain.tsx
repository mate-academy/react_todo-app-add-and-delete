...
export const TodoAppMain = React.memo<Props>(({ loaderClearButton,
   selectedDeleteTodo, loaderDelete, todos, tempTodo, onSelectedTodo}) => {
  const clickButton = useCallback(
    (event: React.MouseEvent<HTMLButtonElement, MouseEvent>, todoId: number) => {
        ...
        >
          ...
          <div
            ...
            className={classNames('modal overlay ', {
              'is-active': todo.title === tempTodo?.title 
